...
From 
	...
	INNER JOIN SaleAuth with(nolock) ON Customer.Company = SaleAuth.Company AND Customer.SalesRepCode = SaleAuth.SalesRepCode
	INNER JOIN UserFile with (nolock) ON UserFile.DcdUserID = SaleAuth.DcdUserID AND UserFile.EMailAddress = '{EmailAddress}'
