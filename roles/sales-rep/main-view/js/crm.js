define(function () {
    ...
    function AddNote (bezl) {
        ...
        switch (bezl.vars.config.CRMPlatform) {
            case "Epicor10":
                require(['https://rawgit.com/bezlio/bezlio-apps/master/roles/sales-rep/main-view/js/integrations/epicor10.js'], function(functions) {
                    functions.addNote(bezl)
                });
                break;
            case "Excel":
                require(['https://rawgit.com/bezlio/bezlio-apps/master/roles/sales-rep/main-view/js/integrations/excel.js'], function(functions) {
                    functions.addNote(bezl)
                });
                break;
            default:
