    ...
    function RunQuery (bezl, queryName) {
        switch (queryName) {
            ...
            case "GetDashHeaderData":
                ...
                parameters[parameterCount] = { "Key": "@DOC_TYPE", "Value": '846' };
                ...
                for (var key in bezl.vars.user.USERS){
                    ...
                    for (var prop in obj){
                        switch (prop.toString()){
                            case "ESI_USER_ID":
                                parameters[parameterCount] = { "Key": "@ESI_USER_ID", "Value": obj[prop] };
                                parameterCount = parameterCount + 1;
                                break;
                            case "ENABLED":
            ...
            case "GetViewDetails":
                ...
                bezl.dataService.add('viewdetails','brdb','EDI','GetViewDetails', { 
                    ...
                    "Connection": bezl.vars.config.sqlConnection,
                    "Parameters": [
                        { "Key": "@DASH_HEADER_ID", "Value": bezl.vars.DASH_HEADER_ID }
                    ] },0);
                    ...
                    for (var prop in obj) {
                        switch (prop.toString()){
                            ...
                            case "EDI_DIRECTION":
                                ...
                                break;
                            case "ESI_FILE_ID":
                                parameters[parameterCount] = { "Key": "@ESI_FILE_ID", "Value": obj[prop] };
                                parameterCount = parameterCount + 1;
                                break;
                            case "DASH_HEADER_ID":
            ...
            case "Reprocess":
                ...
                // Pull in the header data for the logged in user
                bezl.dataService.add('main','brdb','EDI','Reprocess', { 
                    "QueryName": "Reprocess",
                    "Connection": bezl.vars.config.sqlConnection,
                    "Parameters": parameters },0);
