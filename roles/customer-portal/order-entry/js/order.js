define(["./customer.js"], function (customer) {
    ...
    function NewOrder (bezl) {
        ...
        if (bezl.vars.Platform == "Epicor10" || bezl.vars.Platform == "Epicor905") {
            require(['https://cdn.rawgit.com/bezlio/bezlio-apps/1.8/libraries/epicor/order.js'], function(functions) {
                functions.newOrder(bezl);
            }); 
        } else if (bezl.vars.Platform == "Visual8") {
            require(['https://cdn.rawgit.com/bezlio/bezlio-apps/1.8/libraries/visual8/order.js'], function(functions) {
                functions.newOrder(bezl);
            }); 
        }
    }
