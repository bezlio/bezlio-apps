...
```
require(['https://cdn.rawgit.com/bezlio/bezlio-apps/1.2/master/libraries/helloworld.js'], function() {
	helloWorld(); 
}); 
```
...
* [Generate Random Colors Array](https://cdn.rawgit.com/bezlio/bezlio-apps/1.2/master/libraries/generateRandomColorsArray.js)
...
```
var myArray = [];
require(['https://cdn.rawgit.com/bezlio/bezlio-apps/1.2/master/libraries/generateRandomColorsArray.js'], function() {
