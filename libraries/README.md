...
```
require(['https://rawgit.com/bezlio/bezlio-recipes/master/libraries/helloworld.js'], function() {
	helloWorld(); 
}); 
```
...
* [Generate Random Colors Array](https://rawgit.com/bezlio/bezlio-recipes/master/libraries/generateRandomColorsArray.js)
...
```
var myArray = [];
require(['https://rawgit.com/bezlio/bezlio-recipes/master/libraries/generateRandomColorsArray.js'], function() {
