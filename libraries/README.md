...
```
require(['https://bezlio-apps-dev.bezl.io/libraries/helloworld.js'], function() {
	helloWorld(); 
}); 
```
...
* [Generate Random Colors Array](https://bezlio-apps-dev.bezl.io/libraries/generateRandomColorsArray.js)
...
```
var myArray = [];
require(['https://bezlio-apps-dev.bezl.io/libraries/generateRandomColorsArray.js'], function() {
